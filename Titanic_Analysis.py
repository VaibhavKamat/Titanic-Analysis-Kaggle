...
rects1 = ax.bar(index,females_onboard,width,color='blue')
rects2 = ax.bar(index+width,males_onboard,width,color='green')      
ax.set_xticks(index+width)
ax.set_xticklabels(('Class1','Class2','Class3'))
ax.legend((rects1[0],rects2[0]),('Females','Males'),loc='best')
ax.set_ylim(0,400)
plt.title("Number of males and females onboard the Titanic, grouped according to the passenger class")
autolabel(rects1,0.15,0.2)
